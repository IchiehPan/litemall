 ...
 */
@RestController
@RequestMapping("/wx/multimall/goods")
@Validated
public class WxMultimallGoodsController {
    private final Log logger = LogFactory.getLog(WxMultimallGoodsController.class);
    ...
    public Object list(
        ...
        // 查询商品所属类目列表。
        List<Integer> goodsCatIds = goodsService.getCatIds(brandId, keyword, isHot, isNew, mallId);
     ...
     */
    @GetMapping("count")
    public Object count(@NotNull Integer mallId) {
        Integer goodsCount = goodsService.queryOnSale(mallId);
