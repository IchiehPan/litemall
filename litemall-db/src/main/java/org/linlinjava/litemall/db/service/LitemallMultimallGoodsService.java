...
@Service
public class LitemallMultimallGoodsService {
    ...
    public List<LitemallGoods> querySelective(Integer goodsId, String goodsSn, String name, Integer mallId, Integer page, Integer size, String sort, String order) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        LitemallGoodsExample.Criteria criteria = example.createCriteria();
     ...
     * @return
     */
    public Integer queryOnSale(Integer mallId) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        LitemallGoodsExample.Criteria criteria = example.or().andIsOnSaleEqualTo(true).andDeletedEqualTo(false);
    ...
    public List<Integer> getCatIds(Integer brandId, String keywords, Boolean isHot, Boolean isNew, Integer mallId) {
        LitemallGoodsExample example = new LitemallGoodsExample();
        LitemallGoodsExample.Criteria criteria1 = example.or();
        LitemallGoodsExample.Criteria criteria2 = example.or();
        ...
        if (mallId != null) {
            criteria1.andMallIdEqualTo(mallId);
     ...
     * @return
     */
    public List<LitemallGoods> queryByHot(Integer mallId, int offset, int limit) {
        LitemallGoodsExample example = new LitemallGoodsExample();
     ...
     * @return
     */
    public List<LitemallGoods> queryByNew(Integer mallId, int offset, int limit) {
        LitemallGoodsExample example = new LitemallGoodsExample();
