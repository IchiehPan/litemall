...
@Service
public class LitemallMultimallCouponService {
    @Resource
     ...
     * @return
     */
    public List<LitemallCoupon> queryList(Integer mallId, int offset, int limit, String sort, String order) {
        LitemallCouponExample.Criteria criteria = LitemallCouponExample.newAndCreateCriteria();
        if (mallId != null) {
            criteria.andMallIdEqualTo(mallId);
        }
        return queryList(criteria, offset, limit, sort, order);
    }
    ...
    public List<LitemallCoupon> queryAvailableList(Integer userId, Integer mallId, int offset, int limit) {
        assert userId != null;
        // 过滤掉登录账号已经领取过的coupon
        ...
        if (mallId != null) {
            c.andMallIdEqualTo(mallId);
        }
        return queryList(c, offset, limit, "add_time", "desc");
    }

    public List<LitemallCoupon> queryList(Integer mallId, int offset, int limit) {
    ...
    public List<LitemallCoupon> querySelective(String name, Short type, Short status, Integer mallId, Integer page, Integer limit, String sort, String order) {
        LitemallCouponExample example = new LitemallCouponExample();
