...
@Service
public class LitemallMultimallBrandService {
    @Resource
    private LitemallBrandMapper brandMapper;
    private Column[] columns = new Column[]{Column.id, Column.name, Column.desc, Column.picUrl, Column.floorPrice};

    public List<LitemallBrand> query(Integer mallId, Integer page, Integer limit, String sort, String order) {
        LitemallBrandExample example = new LitemallBrandExample();
        LitemallBrandExample.Criteria criteria = example.or().andDeletedEqualTo(false);
        if (mallId != null) {
    ...
    public List<LitemallBrand> query(Integer mallId, Integer page, Integer limit) {
        return query(mallId, page, limit, null, null);
    }
    ...
    public List<LitemallBrand> querySelective(String id, String name, Integer mallId, Integer page, Integer size, String sort, String order) {
        LitemallBrandExample example = new LitemallBrandExample();
        LitemallBrandExample.Criteria criteria = example.createCriteria();
