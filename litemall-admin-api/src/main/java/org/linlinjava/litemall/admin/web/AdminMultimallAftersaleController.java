...
@RestController
@RequestMapping("/admin/multimall/aftersale")
@Validated
public class AdminMultimallAftersaleController {
    private final Log logger = LogFactory.getLog(AdminMultimallAftersaleController.class);

    @Autowired
    private LitemallMultimallAftersaleService aftersaleService;
    @Autowired
    ...
    @RequiresPermissions("admin:multimallaftersale:list")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "查询")
    @GetMapping("/list")
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<LitemallAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, mallId, page, limit, sort, order);
        return ResponseUtil.okList(aftersaleList);
    }

    @RequiresPermissions("admin:multimallaftersale:recept")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "审核通过")
    @PostMapping("/recept")
    ...
    @RequiresPermissions("admin:multimallaftersale:batch-recept")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "批量通过")
    ...
    @RequiresPermissions("admin:multimallaftersale:reject")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "审核拒绝")
    @PostMapping("/reject")
    ...
    @RequiresPermissions("admin:multimallaftersale:batch-reject")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "批量拒绝")
    ...
    @RequiresPermissions("admin:multimallaftersale:refund")
    @RequiresPermissionsDesc(menu = {"商城管理（多商户）", "售后管理"}, button = "退款")
    @PostMapping("/refund")
