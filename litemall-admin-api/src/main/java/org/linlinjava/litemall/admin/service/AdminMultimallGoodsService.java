...
@Service
public class AdminMultimallGoodsService {
    private final Log logger = LogFactory.getLog(AdminMultimallGoodsService.class);
    ...
    public Object list(Integer goodsId, String goodsSn, String name, Integer mallId,
                       Integer page, Integer limit, String sort, String order) {
        List<LitemallGoods> goodsList = goodsService.querySelective(goodsId, goodsSn, name, mallId, page, limit, sort, order);
    ...
    private Object validate(GoodsAllinone goodsAllinone) {
        ...
        Integer mallId = goods.getMallId();
        if (mallId == null) {
            return ResponseUtil.badArgument();
        }
    ...
    public Object list2(Integer mallId) {
        if (mallId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        for (LitemallCategory l1 : l1CatList) {
            ...
            List<LitemallCategory> l2CatList = categoryService.queryByPid(l1.getId(), mallId);
