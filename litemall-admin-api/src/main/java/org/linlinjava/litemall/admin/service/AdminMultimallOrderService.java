...
public class AdminMultimallOrderService {
    private final Log logger = LogFactory.getLog(AdminMultimallOrderService.class);

    @Autowired
    private LitemallOrderGoodsService orderGoodsService;
    @Autowired
    private LitemallMultimallOrderService orderService;
    @Autowired
    ...
    public Object list(String nickname, String consignee, String orderSn, Integer mallId, LocalDateTime start, LocalDateTime end, List<Short> orderStatusArray,
                       Integer page, Integer limit, String sort, String order) {
        Map<String, Object> data = (Map) orderService.queryVoSelective(nickname, consignee, orderSn, mallId, start, end, orderStatusArray, page, limit, sort, order);
